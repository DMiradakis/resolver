...
```bash [Windows]
irm https://raw.githubusercontent.com/DMiradakis/resolver/production/scripts/install.ps1 | iex
```

```bash [Mac]
curl -fsSL https://raw.githubusercontent.com/DMiradakis/resolver/production/scripts/install.sh | bash
```
